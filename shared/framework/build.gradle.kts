...
kotlin {
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            ...
            export(projects.shared.feature.coffeeDetail)
            export(projects.shared.feature.coffeeEditor)
            ...
            export(projects.shared.feature.analysis)
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            api(projects.shared.feature.coffeeDetail)
            api(projects.shared.feature.coffeeEditor)
            ...
            api(projects.shared.feature.analysis)
