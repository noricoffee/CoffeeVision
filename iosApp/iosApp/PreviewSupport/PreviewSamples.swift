...
enum PreviewSamples {
    ...
    /// 未評価（rating = nil）のサンプルコーヒー記録（2026-07-12 B-4 nullable 化。「まず記録、あとで評価」導線の Preview 用）。
    static let sampleCoffeeRecordUnrated: CoffeeRecord = CoffeeRecord(
        id: "coffee-004",
        userId: "preview-user",
        cafe: nil,
        visitedOn: localDate(year: 2026, month: 6, day: 25),
        rating: nil,
        notes: "",
        photos: [],
        name: "本日の一杯",
        ...
        tasting: nil,
        tags: [],
        createdAt: instant(year: 2026, month: 6, day: 25),
        updatedAt: instant(year: 2026, month: 6, day: 25)
    )
